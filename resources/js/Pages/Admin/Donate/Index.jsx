...
const TABLE_HEAD = ['Institute Name', 'Accounts Name', 'Account Number', 'Status', 'Action'];
        ...
        >
          <div className="rounded-none">
            <div className="mb-8 flex items-center justify-between gap-8">
              <div>
                <p className="text-2xl font-bold">Donate Accounts</p>
                <p className="mt-1 font-normal">
                  List of all donate accounts
                </p>
              </div>
                      ...
                      return (
                        ...
                        >
                          <td className="border px-2">
                            <label className="md:hidden">Institute Name</label>
                          ...
                          <td className="border px-2">
                            <label className="md:hidden">Account Name</label>
                            <p className="font-semibold md:font-normal">
                              {page.accounts_name}
                            </p>
                          </td>
                          <td className="border px-2">
                            <label className="md:hidden">Account Number</label>
                            <p className="font-semibold md:font-normal">
                              {page.account_number}
                            </p>
                          </td>
                          <td className="border px-2">
                            ...
                            <span
                              className={`w-fit rounded-md ${page.publishStatus !== 'Published'
                                  ? 'bg-orange-600 '
                                  : 'bg-green-600 '
